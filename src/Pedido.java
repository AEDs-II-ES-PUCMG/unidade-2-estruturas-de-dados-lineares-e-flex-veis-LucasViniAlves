...
public class Pedido implements Comparable<Pedido> {
	...
	public ItemDePedido existeNoPedido(Produto produto) {
		...
		return itensDePedido.buscarPor((a, b) -> a.equals(b) ? 0 : 1, itemDePedidoProcurado);
	}
	...
	public double valorFinal() {
		...
		double valorPedido = itensDePedido.somarMultiplicacoes(ItemDePedido::getPrecoVenda, ItemDePedido::getQuantidade);
